...
export const FlagIcon = () => (
  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 21v-8a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5-5 5h-11" />
  </svg>
);
...
export const SettingsAdjustIcon = ({ className = "w-4 h-4" }: { className?: string }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const CollapseIcon = () => (
  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 14H5.25m4.75 0V18.75m0-4.75L4 19.5M14 10h4.75M14 10V5.25M14 10l5.75-5.75M10 10H5.25M10 10V5.25M10 10L4.25 4.25M14 14h4.75M14 14V18.75M14 14l5.75 5.75" />
  </svg>
);
